...
class MaterialNumberPicker : NumberPicker {
    ...
    private var separatorColor: Int = Color.TRANSPARENT
        set(value) {
            field = value
            divider?.colorFilter = PorterDuffColorFilter(separatorColor, PorterDuff.Mode.SRC_IN)
        }
    private var textColorCustom: Int = DEFAULT_TEXT_COLOR
        set(value) {
            field = value
    ...
    private var editable: Boolean = DEFAULT_EDITABLE
        set(value) {
            field = value
...
//            updateTextAttributes()
    ...
    constructor(
        ...
        this.textColorCustom = textColor
...
////        textColorCustom = a.getColor(R.styleable.MaterialNumberPicker_mnpTextColor, DEFAULT_TEXT_COLOR)
    ...
    private fun updateTextAttributes() {
        ...
        wheelPaint?.let { paint ->
            ...
            (0 until childCount)
                ...
                .firstOrNull()
                ?.let {
                    it.setTextColor(textColorCustom)
